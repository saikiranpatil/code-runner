...
export class ExecutorService {
  ...
  constructor(private readonly config: ConfigService<AppConfig>) {
    ...
    this.executionTimeout = executionConfig.timeout;
    this.maxOutputBytes = executionConfig.maxOutputBytes;
  }

  execute(code: string, language = 'js', timeoutMs = this.executionTimeout) {
    return new Promise((resolve) => {
      ...
      const handleChunk = (target: 'stdout' | 'stderr', chunk: Buffer) => {
